...
def generator():
    if letter_input_1 == "v":
        ...
        letter1 = letter_input_1  # allows the user to chooce the letter
    ...
    if letter_input_2 == "v":
        ...
        letter2 = letter_input_2  # allows the user to chooce the letter
    ...
    if letter_input_3 == "v":
        ...
        letter3 = letter_input_3  # allows the user to chooce the letter
    ...
    if letter_input_4 == "v":
        ...
        letter4 = letter_input_4  # allows the user to chooce the letter
    ...
    if letter_input_5 == "v":
        ...
        letter5 = letter_input_5  # allows the user to chooce the letter
